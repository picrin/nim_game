...
# Warning: each exercise file waits for test input on the standard input. It might appear like your program is stuck in an infite loop but it probably isn't! This is to aid automatic marking, and you can remove this if you don't want to submit your code to http://grader.givegrade.me.uk.
...
# When you run the code it might seem like it's in infite loop. It isn't, it just waits
# for keyboard input.
