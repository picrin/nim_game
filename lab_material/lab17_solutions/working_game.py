...
# Please implement a fully working game of Nim. It's up to you how you achieve this. Command line is fine, but feel free to use Tkinter, Canvas, or even web programming or virtual reality (if you're adventurous)! 
...
# 1. Allow the players to choose any of the 3 required scenarios: Human vs Human, Human vs Computer, Computer vs Computer.
...
# 4. Change turns, but ONLY if the player made a legal move (give some meaningful error message/ allow for input retry).
# 5. Announce the winner when the board is empty.

# If you decide to follow the path of least resistance, you can implement a fairly decent command line interface re-using existing modules in about 20 lines of code.
